...
Phase II
Lets make a better version. Write a new function using O(n) time with O(1) memory. 
...
Well leave the rest to you.

Get your story straight, and then explain your solutions time complexity to your TA.